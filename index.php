...
<section class="hero-area set-bg" data-setbg="img/bg1.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="hero-text">
                        <h1>A  <b style="color: rgb(249,173,129)">Cozy</b> Home</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="facilities-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6">
                    <div class="facilities-item set-bg" data-setbg="img/lux2.jpg">
                        <div class="fi-title">
                ...
                <div class="col-lg-6">
                    <div class="facilities-item set-bg fi-right" data-setbg="img/relax.jpg">
                        <div class="fi-title">
                            <h2>Best Relaxation Center</h2>
    ...
    <div class="video-section">
        <div class="video-bg set-bg" data-setbg="img/lux1.jpg"></div>
        <div class="container">
            <div class="video-text set-bg" data-setbg="img/pillow.jpg">
                <a href="#" class="pop-up"><i class="fa fa-play"></i></a>
            </div>
        </div>
    </div>
    <!-- Video Section End -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="testimonial-item">
                        ...
                        <p>I love The Hotel, Churton Customers Review Goes Here.</p>
                        <div class="ti-author">
                            <div class="author-pic">
                                <img src="design/x1/img/author-2.png" alt="">
                            </div>
                            <div class="author-text">
                                <h6>Amaka Chisom <span>Nigeria</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="testimonial-item">
                        ...
                        <p>This Will be Top two Customer Review For the Hotel</p>
                        <div class="ti-author">
                            <div class="author-pic">
                                <img src="design/x1/img/author-1.png" alt="">
                            </div>
                            <div class="author-text">
                                <h6>Smith Bush <span>UK</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <p> We Offer yor 5 star services, provision of 
                            <b>GYM</b> || <b>FOOD</b> || <b>SPA</b> </p>
                        <a href="#" class="primary-btn">Make a Reservation</a>
                    </div>
                </div>
                <div class="col-lg-6">
