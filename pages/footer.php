  <!-- ============================================================== -->
    ...
    <!-- <script src="../design/x2/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script> -->
    <!-- <script src="../design/x2/assets/vendor/slimscroll/jquery.slimscroll.js"></script> -->
    <script src="../design/x2/assets/vendor/multi-select/js/jquery.multi-select.js"></script>
    <!-- <script src="../assets/libs/js/main-js.js"></script> -->
    <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    <script src="../design/x2/assets/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js"></script>
    <script src="../design/x2/assets/vendor/datatables/js/buttons.bootstrap4.min.js"></script>
    <script src="../design/x2/assets/vendor/datatables/js/data-table.js"></script>
